...
//Forms info
 echo '<div class="container">';
    ...
    getAptType($dbc,$apt_type);
     echo '</p>
    <p>Apartment Number: <input type="text" name="apt_number" size="10" maxlength="3" value="'.$apt_num.'" /><label>(Numeric)</label></p>
    <p>Bedroom Count: <input type="text" name="bedroom_count" size="10" maxlength="3" value="'.$bed_count.'" /><label>(Numeric)</label></p>
    <p>Bathroom Count: <input type="text" name="bathroom_count" size="10" maxlength="3" value="'.$bath_count.'" /><label>(Numeric)</label></p>
    <p>Total rooms: <input type="text" name="room_count" size="10" maxlength="3" value="'.$room_count.'" /><label>(Numeric)</label></p>';
